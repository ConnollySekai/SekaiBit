    ...
    */
    ...
    'custom' => [
        'businessName' => [
            ...
            'max' => 'business name must not exceed 255 characters',
            'unique' => 'business already exists'
        ],
        'websiteUrl' => [
            'required' => 'website url is required',
            'max' => 'website must not exceed 255 characters',
            'url' => 'must be a valid url',
            'unique' => 'website url already exists'
        ],
        'contactEmail' => [
        ...
        'productsServices' => [
            ...
            'max' => 'products/services must not exceed 255 characters',
        ],
        'city' => [
        ...
        'searchTags' => [
            'required' => 'must have at least 1 search tag',
            'array' => 'search tags must be an array',
            'min' => 'must have at least 1 search tag',
            'max' => 'maximum of 5 tags only'
        ],
